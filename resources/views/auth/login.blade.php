                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row">
                                <label for="identify" class="col-md-4 col-form-label text-success text-md-right">{{ __('E-Mail Address Or Mobile Tel') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="password" class="col-md-4 col-form-label text-success text-md-right">{{ __('Password') }}</label>
